...
Архив с собранным проектом [здесь](https://drive.google.com/file/d/1Uf_IbBffV5ItZzc44pv5AgjUHCtekIYm/view?usp=sharing). Для запуска нужна Java версии 8 и выше.

Нужно лишь разархивировать файлы в отдельную папку и запустить программу через `.bat` файл.

Остановка работы приложения:
<ul>
<li>Для сторонников светлой силы: вбить в браузер 
    <code>http://localhost:8080/api/shop/app/shutdown</code>;</li>
